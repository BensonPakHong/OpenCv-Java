...
public class TestLoad {
	static {
		System.load("E:\\openCv\\opencv\\build\\java\\x64\\opencv_java347.dll");
	}
	/**
	 * 测试javacv
	 * 
	 * @date 2019年1月25日
	 */
	public static void testLoadImg(String imgPath) {
        //读取原始图片
...
//        imshow("显示原始图像", image);
      ...
      //加载检测器
  		CascadeClassifier face_cascade = new CascadeClassifier("E:\\openCv\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_frontalface_alt.xml");//初始化人脸检测器
...
//        waitKey(0);
	...
	public static void detectFace() throws org.bytedeco.javacv.FrameGrabber.Exception, InterruptedException
	{
		...
		//加载检测器
		CascadeClassifier face_cascade = new CascadeClassifier("E:\\openCv\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_frontalface_alt.xml");//初始化人脸检测器
		CascadeClassifier eye_cascade = new CascadeClassifier("E:\\openCv\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_eye_tree_eyeglasses.xml");//初始化眼部检测器
        //定义人脸集合，矩形集合
		opencv_core.RectVector faces = new opencv_core.RectVector();
...
//			System.out.println(CmpPic("C:\\Users\\WZJSB-32\\Desktop\\compare\\ym1.jpg", "C:\\Users\\WZJSB-32\\Desktop\\compare\\ym2.jpg"));
//			testLoadImg("C:\\Users\\WZJSB-32\\Desktop\\500.jpg");
			testFace("C:\\Users\\WZJSB-32\\Desktop\\compare\\ym1.jpg");
		} catch (Exception e) {
